# Operator Quickstart — Casting of non-ferrous metals

Shortest path from clone to a verified local dry-run for **ISIC 2432** (`cloud-itonami-isic-2432`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2432.git
cd cloud-itonami-isic-2432
```
...
- Blueprint governor key: `nonferrous-foundry-plant-operations-governor`
- Likely source path: `nonferrousmfg.governor.cljc`
