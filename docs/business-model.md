# Business Model: Casting of non-ferrous metals
...
## Classification
- Repository: `cloud-itonami-isic-2432` ([github.com/cloud-itonami/cloud-itonami-isic-2432](https://github.com/cloud-itonami/cloud-itonami-isic-2432))
- ISIC Rev.5: `2432` — Casting of non-ferrous metals
- Domain: `:non-ferrous-metal-casting/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency :environmental-health
- Actor: `:nonferrous-foundry-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :non-ferrous-metal-casting/manufacturing — who wants
...
One managed tenant (:non-ferrous-metal-casting/manufacturing):
...
- Do not bypass the `:nonferrous-foundry-plant-operations-governor` for production decisions.
