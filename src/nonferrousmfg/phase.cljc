(ns nonferrousmfg.phase
  "Phase 0->3 staged rollout for the non-ferrous metal casting foundry
  ...
  consequence (a melting-furnace/mold/shakeout/die-casting-equipment
  maintenance window means production downtime, and the equipment ends
  up actually touched); it is always a human plant supervisor's call.
  `nonferrousmfg.governor`'s `furnace-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Non-Ferrous Foundry Plant Operations Governor verdict to a
