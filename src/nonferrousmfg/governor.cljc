...
(def allowed-proposal-effects
  ...
  pouring-line/dust-collector-equipment-control effect, a purchase-order
  issue, or a funds-committing act."
...
(def high-stakes
  ...
  Safety concerns, equipment-procurement commitments and combustible-dust
  coordination are the ops in this domain that always demand human eyes
  regardless of confidence -- a safety concern because it is a safety
  concern; a procurement draft because approving it becomes a real
  financial commitment (purchase order / payment), which is always the
  human approver's act, never this actor's; a dust-control proposal
  because magnesium finishing dust is combustible and reacts with water,
  so it is reviewed by a human plant supervisor."
  #{:coordination/safety-concern
    :coordination/equipment-procurement
    :coordination/dust-hazard})
